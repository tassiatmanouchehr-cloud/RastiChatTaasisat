...
class WidgetChatConsumer(BaseChatConsumer):
    ...
    async def receive_json(self, content):
        ...
        if not msg: return
        await self.channel_layer.group_send(self.group_name, {'type': 'chat.message', 'message': {'id': str(msg.id), 'sender_type': 'VISITOR', 'content': msg.content, 'created_at': msg.created_at.isoformat()}})
